...
<%@ page import="com.tangailquiz.model.Result" %>
...
<head>
    ...
    <style>
        ...
        h1 { color:#7a2d1c; font-size:20px; margin-bottom:20px; }
        ...
        a { display:inline-block; margin-top:20px; padding:10px 18px; background:#7a2d1c; color:#fff; text-decoration:none; border-radius:6px; font-size:14px; }
    </style>
</head>
<body>
<div class="container">
