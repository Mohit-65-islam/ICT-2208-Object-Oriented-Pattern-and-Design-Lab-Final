...
<%@ page import="com.tangailquiz.model.Question" %>
<%@ page import="java.util.List" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Quiz - Tangail District Upazilas</title>
    <style>
        ...
        h1 { color:#7a2d1c; font-size:20px; }
        ...
        .tag { display:inline-block; font-size:11px; background:#f3e6e2; color:#7a2d1c; padding:2px 8px; border-radius:10px; margin-bottom:6px; }
        label { display:block; margin:6px 0; font-size:14px; cursor:pointer; }
        button { padding:12px 24px; background:#7a2d1c; color:#fff; border:none; border-radius:6px; font-size:15px; cursor:pointer; }
