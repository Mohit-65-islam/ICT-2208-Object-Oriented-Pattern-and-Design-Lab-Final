...
<head>
    ...
    <style>
        ...
        .score { font-size:48px; font-weight:bold; color:#7a2d1c; margin:20px 0 6px; }
        .out-of { color:#777; margin-bottom:24px; }
        a { display:inline-block; margin:6px 8px; padding:10px 18px; background:#7a2d1c; color:#fff; text-decoration:none; border-radius:6px; font-size:14px; }
